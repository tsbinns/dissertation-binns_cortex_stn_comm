%% Create interpolated SSD patterns and plot raw points (Figures 4A & 5)
...
%% MED OFF and ON averaged (Figure 4A)
...
%% MED OFF and ON separately (Figure 5A)
...
%% STIM OFF and ON separately (Figure 5B)
